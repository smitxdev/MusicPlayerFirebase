package com.example.musicplayeradvance;
...
import com.example.musicplayeradvance.databinding.ActivityMainBinding;
...
import com.example.musicplayeradvance.viewmodels.activities.MainActivityViewModel;
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        storageReference.child("images/profiles/" + uid).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onFailure(@NonNull Exception exception) {
                                ...
                                if ((Integer.parseInt(Objects.requireNonNull(snapshot.child("login_method").getValue()).toString())) != 1) {
