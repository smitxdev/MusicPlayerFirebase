package com.example.musicplayeradvance.fragments.playlists;
...
import com.example.musicplayeradvance.models.FirebaseSong;
import com.example.musicplayeradvance.models.Playlist;
import com.example.musicplayeradvance.models.Song;
import com.example.musicplayeradvance.viewmodels.fragments.playlists.CurrentPlaylistFragmentViewModel;
import com.example.musicplayeradvance.viewmodels.fragments.profile.ProfileFragmentViewModel;
                    ...
                    if (snapshot != null) {
                        ...
                        if (x != 0) {
                            ...
                            for (DataSnapshot ds : snapshot.child("songs").getChildren()) {
                                ...
                                firebaseSong.setOrder(Integer.valueOf(Objects.requireNonNull(ds.child("order").getValue()).toString()));
                                firebaseSong.setPath(Objects.requireNonNull(ds.child("path").getValue()).toString());
                                firebaseSong.setTitle(Objects.requireNonNull(ds.child("title").getValue()).toString());
